...
@Api(value = "User Management System",
    description = "Operations pertaining to user in User Management System")
...
//      @ApiResponse(code = 404, message = "The resource you were trying to reach is not found")})
  ...
  public ResponseEntity<?> login(@Valid @RequestBody UserLoginRequestModel login,
  ...
  public ResponseEntity<?> readMenuByUser(@ApiParam(value = "id of user use get menu ",
  ...
  public ResponseEntity<?> updateUser(
      @ApiParam(value = "update User object store in database table",
  ...
  public ResponseEntity<UserDto> getDetail(@ApiParam(value = "User object store in database table",
      required = true) @RequestBody Long id) {
